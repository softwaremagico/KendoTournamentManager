...
/**
 * Logger wrapper for WebSocket operations.
 */
public final class WebsocketsLogger extends AbstractLoggerWrapper {

    private static final Logger LOGGER = LoggerFactory.getLogger(WebsocketsLogger.class);

    private WebsocketsLogger() {
    }
