...
public class TournamentNotFoundException extends NotFoundException {
    ...
    public TournamentNotFoundException(Class<?> clazz, String message) {
        super(clazz, message, ExceptionType.WARNING);
    }

    public TournamentNotFoundException(Class<?> clazz) {
        this(clazz, "User not found");
    }

    public TournamentNotFoundException(Class<?> clazz, Throwable e) {
        super(clazz, e);
    }
}
