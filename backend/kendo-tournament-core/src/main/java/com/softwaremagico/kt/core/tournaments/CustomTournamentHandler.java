...
@Service
public class CustomTournamentHandler extends SimpleTournamentHandler {


    public CustomTournamentHandler(GroupProvider groupProvider, FightManager fightManager, FightProvider fightProvider,
                                   TeamProvider teamProvider, GroupConverter groupConverter, RankingController rankingController) {
        super(groupProvider, fightManager, fightProvider, teamProvider, groupConverter, rankingController);
    }
