...
public class LevelNotFinishedException extends LoggedException {
    ...
    public LevelNotFinishedException(Class<?> clazz, String message) {
        super(clazz, message, ExceptionType.WARNING, HttpStatus.NOT_FOUND);
    }

    public LevelNotFinishedException(Class<?> clazz) {
        this(clazz, "Unexpected!");
    }

    public LevelNotFinishedException(Class<?> clazz, Throwable e) {
        super(clazz, e);
    }
}
