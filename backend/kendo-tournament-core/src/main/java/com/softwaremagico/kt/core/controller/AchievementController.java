...
public class AchievementController
		extends
			BasicInsertableController<Achievement, AchievementDTO, AchievementRepository, AchievementProvider, AchievementConverterRequest, AchievementConverter> {
	...
	private List<Participant> getParticipantsFromTournament(Tournament tournament) {
		...
		this.participantsFromTournament.computeIfAbsent(tournament, t -> this.participantProvider.get(tournament));
	...
	public List<AchievementDTO> regenerateAllAchievements() {
		...
		for (final AchievementsGeneratedAllTournamentsListener achievementsGeneratedAllTournamentsListener : this.achievementsGeneratedAllTournamentsListeners) {
