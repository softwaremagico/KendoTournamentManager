...
public class KingOfTheMountainFiFoTest extends AbstractTestNGSpringContextTests {
    ...
    public void addTournament() {
        ...
        TournamentExtraProperty tournamentExtraProperty = new TournamentExtraProperty(tournament,
    ...
    public void team1Loose() {
        ...
        //2nd team remains. But the 1st must be out.
    ...
    public void afterDraw() {
        ...
        //First team to enter must be removed
        Assert.assertEquals(tournamentFights.get(5).getTeam1(), tournamentFights.get(4).getTeam2());

        Assert.assertEquals(tournamentFights.get(5).getTeam1().getName(), "Team03");
        Assert.assertEquals(tournamentFights.get(5).getTeam2().getName(), "Team04");
    }
