...
public class BubbleSortReversedTest extends AbstractTestNGSpringContextTests {
    ...
    public void firstIteration() {
        ...
        //The Second fight must be done team4 vs. team2. It is won by team4
        ...
        //The Third fight must be done team4 vs. team1. It is won by team4
        bubbleSortTournamentHandler.generateNextFights(tournament, null);
        tournamentFights = fightProvider.getFights(tournament);
    ...
    public void secondIteration() {
        ...
        //The First fight is team3 vs. team2. It is won by team3
        List<Fight> tournamentFights = fightProvider.getFights(tournament);
        ...
        //The Second fight must be done team3 vs. team1. It is won by team3
        bubbleSortTournamentHandler.generateNextFights(tournament, null);
        tournamentFights = fightProvider.getFights(tournament);
    ...
    public void thirdIteration() {
        ...
        //The First fight is team2 vs. team1. It is won by team2
        List<Fight> tournamentFights = fightProvider.getFights(tournament);
