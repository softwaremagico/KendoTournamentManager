...
@SpringBootTest
@Test(groups = {"tournament5GroupsTest"})
public class Tournament5GroupsTest extends AbstractTestNGSpringContextTests {
    ...
    public void populateLevel1() {
        ...
        Assert.assertEquals(groups.get(1).getTeams().get(0).getName(), "Team09");
        Assert.assertEquals(groups.get(1).getTeams().get(1).getName(), "Team10");

        //Group 3 -> Only Team13
        Assert.assertEquals(groups.get(2).getTeams().get(0).getName(), "Team13");
    ...
    public void populateLevel2() {
        ...
        Assert.assertEquals(groups.get(1).getTeams().get(0).getName(), "Team10");
    ...
    public void solveLevel3() {
        ...
        // First group has team10 as winner.
        ...
        Assert.assertEquals(rankingProvider.getTeamsRanking(groups.get(0)).get(0).getName(), "Team10");
    }
    ...
    public void checkFinalRanking() {
        ...
        Assert.assertEquals(score.get(0).getTeam().getName(), "Team10");
        Assert.assertEquals(score.get(1).getTeam().getName(), "Team01");
        Assert.assertEquals(score.get(2).getTeam().getName(), "Team13");
        //Same score but ordered by name.
        Assert.assertEquals(score.get(3).getTeam().getName(), "Team06");
        Assert.assertEquals(score.get(4).getTeam().getName(), "Team09");
        //Same score but ordered by name.
        Assert.assertEquals(score.get(5).getTeam().getName(), "Team02");
        Assert.assertEquals(score.get(6).getTeam().getName(), "Team03");
        Assert.assertEquals(score.get(7).getTeam().getName(), "Team04");
        Assert.assertEquals(score.get(8).getTeam().getName(), "Team05");
        Assert.assertEquals(score.get(9).getTeam().getName(), "Team07");
        Assert.assertEquals(score.get(10).getTeam().getName(), "Team08");
        Assert.assertEquals(score.get(11).getTeam().getName(), "Team11");
        Assert.assertEquals(score.get(12).getTeam().getName(), "Team12");
        Assert.assertEquals(score.get(13).getTeam().getName(), "Team14");
