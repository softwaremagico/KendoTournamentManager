...
@SpringBootTest
@Test(groups = {"deleteGroupsTwoWinnersTest"})
public class TournamentDeleteGroupsTwoWinnersTest extends AbstractTestNGSpringContextTests {
    ...
    public void add8Groups() {
        ...
        Assert.assertEquals(groupController.count(), 23);
    }
    ...
    public void deleteGroupsOneByOne() {
        ...
        Assert.assertEquals(groupController.count(), 22);
        ...
        groupController.delete(level0Groups.get(level0Groups.size() - 1), null, null);
        level0Groups.remove(level0Groups.size() - 1);
        Assert.assertEquals(groupController.count(), 20);
        ...
        groupController.delete(level0Groups.get(level0Groups.size() - 1), null, null);
        level0Groups.remove(level0Groups.size() - 1);
        Assert.assertEquals(groupController.count(), 10);

        //2 groups left
        groupController.delete(level0Groups.get(level0Groups.size() - 1), null, null);
        level0Groups.remove(level0Groups.size() - 1);
        Assert.assertEquals(groupController.count(), 5);

        groupController.delete(level0Groups.get(level0Groups.size() - 1), null, null);
        level0Groups.remove(level0Groups.size() - 1);
        Assert.assertEquals(groupController.count(), 2);
