...
/**
 * Logger wrapper for frontend operations.
 */
public final class FrontendLogger extends AbstractLoggerWrapper {

    private static final Logger LOGGER = LoggerFactory.getLogger(FrontendLogger.class);
