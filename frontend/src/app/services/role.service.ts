...
export class RoleService {
  ...
  getAll(): Observable<Role[]> {
    ...
    return this.http.get<Role[]>(url, this.loginService.httpOptions)
      .pipe(
        tap({
  ...
  delete(role: Role): Observable<Role> {
    ...
    return this.http.post<Role>(url, role, this.loginService.httpOptions)
      .pipe(
        tap({
  ...
  update(role: Role): Observable<Role> {
    const url: string = `${this.baseUrl}`;
    return this.http.put<Role>(url, role, this.loginService.httpOptions)
      .pipe(
        tap({
